...
function CustomButton({ text, className, loading }: ButtonProp) {
...
export default function Home() {
    return (
        <div className="h-screen w-full bg-neutral flex justify-center items-center">
            <CustomButton text='Submit' loading={false} />
        </div>
    )
}