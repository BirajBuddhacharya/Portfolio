  ...
  return (
    <section className="max-w-[1180px] mx-auto px-7 pt-[170px] pb-[90px]">
      ...
      >
        ...
        >
          available for freelance &amp; full-time — kathmandu, npt
        </span>
      </motion.div>
      ...
      >
        Biraj<br />Buddhacharya<span style={{ color: '#FF6B6B' }}>.</span>
      </motion.h1>
      ...
      >
        ...
        >
          Machine learning engineer and full-stack developer. I build backends that think — RAG chatbots,
          recommendation engines and analytics systems — and the interfaces that make them usable.
        </p>
