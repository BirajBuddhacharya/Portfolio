          ...
          <div className="px-16 w-1/2 flex items-center justify-center">
            <div className="text-left">
              ...
              <div className="inline">
                <h1 className="text-primary typewrite">
                  <span>Biraj</span>
                </h1>
              </div>
              <p className="text-neutral-light text-sm tracking-tighter my-2">
                Aspiring software engineer and Deep Learning Enthiguist aiming
                to solve real world problem with tech.
              </p>
